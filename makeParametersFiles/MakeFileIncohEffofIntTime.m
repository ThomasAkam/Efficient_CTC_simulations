...
% Make parameter file to assess affect of integration time using incoherent distractors.

Name='IncohEffofIntTime';
...
paramsouter=[{'ip.senderfreq'},{'ip.distractorfreqs'}]
paramsoutervalues=[[12.5,25,50,100];[12.5,25,50,100]];
